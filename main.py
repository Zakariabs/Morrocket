...
UFO = pygame.image.load(os.path.join("assets", "ufo.png"))
# Lasers inladen
...
def main():      # we gaan de main functie aanmaken zodat we het spel kunnen aanroepen
    ...
    player2 = Player(300, 630)   # we gaan het schip aanmaken zodat we het schip kunnen aanroepen in het spel
    ...
    while run:
        ...
        for enemy in enemies[:]: # we gaan de enemies aanmaken in het spel
            ...
            enemy.move_lasers(laser_vel, player) # we gaan de enemy lasers aanmaken zodat we de lasers van de enemies kunnen aanpassen in het spel
